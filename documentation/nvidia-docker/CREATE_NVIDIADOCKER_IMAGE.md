...
# Tag your image
sudo docker tag 7ef920844953 opendatacam/opendatacam:v2.1.2-nvidiadocker_cuda_archbin_6_1

# Untag image (if you made a tipo)
sudo docker rmi opendatacam/opendatacam:v2.1.2-nvidiadocker_cuda_archbin_6_1

# Push image
sudo docker push opendatacam/opendatacam:v2.1.2-nvidiadocker_cuda_archbin_6_1
```
