...
# Tag your image
sudo docker tag <IMAGEID> opendatacam/opendatacam:v2.1.1-nano

# Or for tx2 : opendatacam/opendatacam:v2.1.1-tx2
# Or for xavier : opendatacam/opendatacam:v2.1.1-xavier

# Push image
sudo docker push opendatacam/opendatacam:v2.1.1-nano


# (optional) Useful Untag image (if you made a tipo)
sudo docker rmi opendatacam/opendatacam:v2.1.1-nano
```
