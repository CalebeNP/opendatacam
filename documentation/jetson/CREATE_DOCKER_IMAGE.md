...
# Tag your image
sudo docker tag <IMAGEID> opendatacam/opendatacam:v2.1.2-nano

# Or for tx2 : opendatacam/opendatacam:v2.1.2-tx2
# Or for xavier : opendatacam/opendatacam:v2.1.2-xavier

# Push image
sudo docker push opendatacam/opendatacam:v2.1.2-nano


# (optional) Useful Untag image (if you made a tipo)
sudo docker rmi opendatacam/opendatacam:v2.1.2-nano
```
