# OpenDataCam 2.1.4 – An open source tool to quantify the world
...
- [OpenDataCam 2.1.4](#opendatacam-210)
...
wget -N https://raw.githubusercontent.com/CalebeNP/opendatacam/v2.1.4/docker/install-opendatacam.sh
